...
var OracleConnection = /** @class */ (function (_super) {
    ...
    function OracleConnection() {
        ...
        oracledb_1.default.maxRows = 100;
        return _this;
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _a = this;
                        _c = (_b = oracledb_1.default).getConnection;
                        _d = config;
    ...
    OracleConnection.prototype.createCommand = function (commandText, binds) {
        var cmd = new OracleSqlCommand_1.default(this.$conn, commandText);
        cmd.binds = binds || {};
        return cmd;
    };
    OracleConnection.prototype.createQuery = function (commandText, binds) {
        var qry = new OracleSqlQuery_1.default(this.$conn, commandText);
        qry.binds = binds || {};
        return qry;
    };
...
//# sourceMappingURL=OracleConnection.js.map